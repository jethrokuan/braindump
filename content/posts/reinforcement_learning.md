...
author = ["Jethro Kuan"]
lastmod = 2019-09-30T09:01:45+08:00
...
utility of its successor states: i.e. it obeys the [Bellman Equation](#org04fb99b)
for a fixed policy.
...
defined by the optimal policy, governed by the [Bellman equations](#org04fb99b).
...
[update rule for TD](#org2a95241) remains unchanged. IT can be shown that the TD
