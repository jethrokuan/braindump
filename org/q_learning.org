...
- tags :: [[file:machine_learning_algorithms.org][Machine Learning Algorithms]], [[file:td_learning.org][Temporal Difference Learning]], [[file:reinforcement_learning.org][Reinforcement Learning ⭐]]

The [[file:actor_critic.org][Actor-Critic]] algorithm fits 2 function approximators: one for the
...
omit [[file:policy_gradients.org][Policy Gradients]] completely?/
...
This works, even for off-policy samples (unlike [[file:actor_critic.org][§actor_critic]]). In
...
gradient clipping. See [[file:mnih2013_atari_deeprl.org][Playing Atari with Deep RL]].
...
algorithm that stabilized deep Q-learning ([[file:mnih2013_atari_deeprl.org][Playing Atari with Deep
RL]]).
