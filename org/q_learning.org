...
The actor-critic algorithm ([[file:actor_critic.org][§actor_critic]]) fits 2 function
...
the gradient update. /Can we omit policy gradients completely
...
gradient clipping. See [[file:mnih2013_atari_deeprl.org][§mnih2013_atari_deeprl]].
