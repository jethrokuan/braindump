...
where $I(\theta)$ is the expected [[file:20200216233903.org][Fisher information]] in the model.
...
where I is the [[file:20200216233903.org][Fisher information matrix]]. When the number of
