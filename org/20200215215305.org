...
#+HUGO_SLUG: git_scalar
#+TITLE: Git Scalar

- tags :: [[file:git.org][Git]]

Git has trouble handling large repositories. This problem is resolved
using [[file:20200215215404.org][VFS for Git]]. This is essentially a wrapper around GVFS,
...
The [[file:20200215215404.org][VFS for Git]] protocol reduces object transfer.
