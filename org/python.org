...
#+HUGO_TAGS: python programming_languages
#+TITLE: Python
...
* Numpy
[[https://github.com/rougier/from-python-to-numpy/][rougier/from-python-to-numpy]] is a great reference to see how to speed
...
* Optimizing Python
[[https://gregoryszorc.com/blog/2019/01/10/what-i've-learned-about-optimizing-python/][Gregory Szorc's Digital Home | What I've Learned About Optimizing
Python]]
