...
- author :: [[file:martin_kleppmann.org][Martin Kleppmann]]
...
- When a write comes in, add it into an in-memory balanced data
  structure (e.g. [[file:red_black_tree.org][Red-Black Tree]]). This is sometimes referred to as a /memtable/.
...
[[https://github.com/google/leveldb][LevelDB]] and [[https://github.com/facebook/rocksdb][RocksDB]] use a [[file:bloom_filter.org][Bloom Filter]], which is a memory-efficient
