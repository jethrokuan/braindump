...
- tags :: [[file:machine_learning.org][Machine Learning]], [[file:research.org][Research]]
- author :: [[file:john_schulman.org][John Schulman]]
...
[[file:john_schulman.org][John Schulman]] recommends goal-driven research.
...
2. Aim high, and climb incrementally towards high goals
   1. Keep a notebook, and record daily ideas and experiments
      ([[file:note_taking.org][Note-taking]]). [[file:john_schulman.org][John Schulman]] creates an entry for each day, and
