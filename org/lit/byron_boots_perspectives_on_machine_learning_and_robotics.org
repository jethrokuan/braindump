...
[[file:../erm.org][Empirical Risk Minimization]] is too strong: data is not i.i.d, not batched, not
in the model class. Solution: use [[file:online_learning.org][online learning]], that makes minimal
assumptions.

Online learning has simple derivations, insights from optimization, and may
suggest better algorithms.

[[file:model_predictive_control.org][Model Predictive Control]] is an effective approach to handling challenging
dynamic environments with simple models, because it allows for local
optimization of simple policies.

[[file:../reinforcement_learning.org][Reinforcement Learning]] can learn complex policies, and is often state-of-the-art
...
[[file:../imitation_learning.org][Imitation Learning]] provides a general way to accelerate policy learning, by
