...
models. [[file:mahler_dex_net_2017.org][mahler_dex-net_2017: Dex-Net 2.0: Deep Learning to Plan Robust Grasps
with Synthetic Point Clouds and Analytic Grasp Metrics]] uses deep learning
methods to plan grasps.

Other methods such as in [[file:morrison_closing_2018.org][morrison_closing_2018: Closing the Loop for Robotic
