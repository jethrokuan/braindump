...
SimCLR is a simple framework for [[file:contrastive_methods.org][Contrastive Methods]] of visual representations.
...
Rather than train with a memory bank, they use a large batch size, and the [[file:../lars_optimizer.org][LARS Optimizer]] to stabilize training.
