...
#+HUGO_SLUG: multimodal_translation
#+TITLE: Multi-modal Translation

Multi-modal translation is a sub-challenge in [[file:20200219115844_multimodal_machine_learning.org][multi-modal machine
...
#+CAPTION: Example-based and generative multi-modal translation cite:baltrusaitis17:_multim_machin_learn
