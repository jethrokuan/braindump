...
Gibbs sampling is a special case of the [[file:metropolis_hastings.org][§metropolis_hastings]] method,
...
* Pros and Cons
1. Suffers the same defects as [[file:metropolis_hastings.org][§metropolis_hastings]] methods
