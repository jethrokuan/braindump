...
significantly more difficult problem compared to [[file:robot_localization.org][Robot Localization]]
and [[file:occupancy_grid_mapping.org][Occupancy Grid Mapping]].
...
matrix and information state vector (See [[file:information_filter.org][Information Filter]]).
