...
significantly more difficult problem compared to [[file:robot_localization.org][§robot_localization]]
and [[file:occupancy_grid_mapping.org][§occupancy_grid_mapping]].
...
matrix and information state vector ([[file:information_filter.org][§information_filter]]).
