...
observes the environment's state (sometimes partially: [[file:pomdp.org][POMDPs]]) and
chooses an action.
...
The dynamics and rewards here reflect the [[file:markovian_assumption.org][markovian assumption]].
...
- [[file:mcts.org][Monte Carlo Tree Search]]
- [[file:deep_rl.org][Deep Reinforcement Learning]]
- [[file:td_learning.org][Temporal Difference Learning]]
- [[file:policy_gradients.org][Policy Gradients]]
- [[file:actor_critic.org][Actor-Critic]]
- [[file:q_learning.org][Q-Learning]]
