...
observes the environment's state (sometimes partially: [[file:pomdp.org][§pomdp]]) and
chooses an action.
...
The dynamics and rewards here reflect the [[file:markovian_assumption.org][§markovian_assumption]].
...
* Related
- [[file:markov_decision_process.org][§markov_decision_process]]
- [[file:mcts.org][§mcts]]
- [[file:deep_rl.org][§deep_rl]]
