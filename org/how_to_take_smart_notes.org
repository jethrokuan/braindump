...
:PROPERTIES:
:NOTER_PAGE: (8 . 6823)
:ID:       104f4b83-cf44-4bd4-bcec-fee48a75c7bb
:END:
...
:NOTER_PAGE: (13 . 7682)
:END:
** why the threshold to write an idea down has to be as low as possible, but it is equally crucial to elaborate on them within a day or two
:PROPERTIES:
:NOTER_PAGE: (13 . 13465)
:END:
