...
* Details
Mathematical derivation makes the [[file:markovian_assumption.org][§markovian_assumption]].
...
- Ease of implementation :: Difficulty in implementation typically
  ...
  (see [[file:robotics_probabilistic_generative_laws.org][§robotics_probabilistic_generative_laws]]). Particle
